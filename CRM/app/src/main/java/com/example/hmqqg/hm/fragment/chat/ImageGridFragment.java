...
import com.example.hmqqg.hm.BuildConfig;
import com.example.hmqqg.hm.R;
import com.example.hmqqg.hm.activity.chat.RecorderVideoActivity;
import com.example.hmqqg.hm.domain.VideoEntity;
import com.example.hmqqg.hm.util.util.ImageCache;
import com.example.hmqqg.hm.util.util.ImageResizer;
import com.example.hmqqg.hm.util.util.Utils;

import java.util.ArrayList;
import java.util.List;

import easeui.widget.RecyclingImageView;
