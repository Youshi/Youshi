 ...
 */
public class Mywork_adapter extends BaseAdapter {
    private List<DailyEntity_d.CommentsEntity> data;
    Context context;

    public Mywork_adapter(List<DailyEntity_d.CommentsEntity> list, Context context) {
        super();
        this.data = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DailyEntity_d.CommentsEntity cd = data.get(position);
