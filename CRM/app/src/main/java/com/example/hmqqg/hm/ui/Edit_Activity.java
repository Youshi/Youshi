...
/**
 * 修改客户资料
 * Created by bona on 2016/4/16.
 */
public class Edit_Activity extends BaseRequestActivity implements View.OnClickListener,DatePicker.OnDateChangedListener,TimePicker.OnTimeChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tel1 = intent.getStringExtra("tel1");
        birthday1 = intent.getStringExtra("birthday1");
        origine1 = intent.getStringExtra("origine1");
        sex1 = intent.getStringExtra("sex1");
        address1 = intent.getStringExtra("address1");
        certifiyType1 = intent.getStringExtra("certifiyType1");
        certifiyNO1 = intent.getStringExtra("certifiyNO1");
        purpose1 = intent.getStringExtra("purpose1");
        invest1 = intent.getStringExtra("invest1");
        email1 = intent.getStringExtra("email1");
        profession1 = intent.getStringExtra("profession1");
        contact1 = intent.getStringExtra("contact1");
        marriage1 = intent.getStringExtra("marriage1");
        phone1 = intent.getStringExtra("phone1");
        relation1 = intent.getStringExtra("relation1");
        named1 = intent.getStringExtra("named1");
        initView();
    }
...
//            startActivity(intent);
    ...
    private void getsave() {
        ...
        if (Sprofession.equals("工业")) {//从事职业
            Sprofession = "KHHY001";
        } else if (Sprofession.equals("服务业")) {
            Sprofession = "KHHY002";
        } else if (Sprofession.equals("餐饮业")) {
            Sprofession = "KHHY003";
        } else if (Sprofession.equals("通讯")) {
            Sprofession = "KHHY004";
        } else if (Sprofession.equals("邮电")) {
            Sprofession = "KHHY005";
        } else if (Sprofession.equals("社区服务")) {
            Sprofession = "KHHY006";
        } else if (Sprofession.equals("批发零售")) {
            Sprofession = "KHHY007";
        }
...
//            }
        ...
        if (Srelation == null || Srelation.equals("")) {
            Toast.makeText(this, "与客户关系不能为空", Toast.LENGTH_SHORT).show();
            return;
        }
        if (Snamed == null || Snamed.equals("")) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                requestParams.addBodyParameter("action", "custinfoedit");
    ...
    public android.app.AlertDialog dateTimePicKDialog(final TextView inputDate) {
        LinearLayout dateTimeLayout = (LinearLayout) Edit_Activity.this
                .getLayoutInflater().inflate(R.layout.common_date, null);
        datePicker = (DatePicker) dateTimeLayout.findViewById(R.id.datepicker);
//        timePicker = (TimePicker) dateTimeLayout.findViewById(R.id.timepicker);
        init(datePicker, null);
//        timePicker.setIs24HourView(true);
//        timePicker.setOnTimeChangedListener(Edit_Activity.this);

        ad = new android.app.AlertDialog.Builder(Edit_Activity.this)
    ...
    public void init(DatePicker datePicker, TimePicker timePicker) {
        ...
        datePicker.init(calendar.get(Calendar.YEAR),
                ...
                calendar.get(Calendar.DAY_OF_MONTH),Edit_Activity.this);
