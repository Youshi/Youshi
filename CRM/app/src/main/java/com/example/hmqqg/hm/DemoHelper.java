...
import com.example.hmqqg.hm.util.util.PreferenceManager;
...
import easeui.parse.UserProfileManager;
import easeui.receiver.CallReceiver;
...
//            EMContactManager.getInstance().setContactListener(new MyContactListener());
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactAdded(List<String> usernameList) {
            ...
            DemoHelper.getInstance().setContactList(localUsers);
            // 刷新ui
...
//                inviteMzessgeDao.deleteMessage(username);
            }
            broadcastManager.sendBroadcast(new Intent(Constant.ACTION_CONTACT_CHANAGED));
        }

        @Override
        public void onContactInvited(String username, String reason) {//对方添加你为好友
...
//            homefragment.isShowRed(true);//显示红点
        ...
        @Override
        public void onContactAgreed(String username) {//对方同意添加你为好友
            List<InviteMessage> msgs = inviteMessgeDao.getMessagesList();
            for (InviteMessage inviteMessage : msgs) {
...
//        user = getContactList().get(username);
   ...
   public void asyncFetchContactsFromServer(final EMValueCallBack<List<String>> callback){//从服务器获取好友列表
