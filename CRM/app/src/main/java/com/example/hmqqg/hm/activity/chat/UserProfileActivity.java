...
public class UserProfileActivity extends EaseBaseActivity implements OnClickListener{
	...
	private void initView() {
		...
		headPhotoUpdate = (ImageView) findViewById(R.id.user_head_headphoto_update);//头像右下角的相机标记
		tvUsername = (TextView) findViewById(R.id.user_username);//用户账号
		tvNickName = (TextView) findViewById(R.id.user_nickname);//昵称
		rlNickName = (RelativeLayout) findViewById(R.id.rl_nickname);
		iconRightArrow = (ImageView) findViewById(R.id.ic_right_arrow);//向右箭头
	}
	...
	private void initListener() {
		...
		if(username != null){
    		if (username.equals(EMChatManager.getInstance().getCurrentUser())) {
    			tvUsername.setText(EMChatManager.getInstance().getCurrentUser());//用户账号
...
//						 Glide.with(UserProfileActivity.this).load(user.getAvatar()).placeholder(R.mipmap.em_default_avatar).into(headAvatar);
//					}else{
//					    Glide.with(UserProfileActivity.this).load(R.mipmap.em_default_avatar).into(headAvatar);
//					}
//				}
//			}
//
