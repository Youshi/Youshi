package com.example.hmqqg.hm.fragment.chat;
...
import com.example.hmqqg.hm.activity.chat.ChatRoomDetailsActivity;
import com.example.hmqqg.hm.activity.chat.ContextMenuActivity;
import com.example.hmqqg.hm.activity.chat.ForwardMessageActivity;
import com.example.hmqqg.hm.activity.chat.GroupDetailsActivity;
import com.example.hmqqg.hm.activity.chat.ImageGridActivity;
import com.example.hmqqg.hm.activity.chat.UserProfileActivity;
import com.example.hmqqg.hm.activity.chat.VideoCallActivity;
import com.example.hmqqg.hm.activity.chat.VoiceCallActivity;
import com.example.hmqqg.hm.common.Constant;
import com.example.hmqqg.hm.domain.EmojiconExampleGroupData;
import com.example.hmqqg.hm.domain.RobotUser;
...
import easeui.widget.ChatRowVoiceCall;
...
//            break;
    ...
    protected void startVoiceCall() {
        if (!EMChatManager.getInstance().isConnected()) {
            Toast.makeText(getActivity(), R.string.not_connect_to_server, Toast.LENGTH_LONG).show();
        } else {
