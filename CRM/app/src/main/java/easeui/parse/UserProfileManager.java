...
import com.example.hmqqg.hm.DemoHelper.DataSyncListener;
...
public class UserProfileManager {
	...
	public synchronized void reset() {
		isSyncingContactInfosWithServer = false;
		currentUser = null;
		com.example.hmqqg.hm.util.util.PreferenceManager.getInstance().removeCurrentUserInfo();
	}
